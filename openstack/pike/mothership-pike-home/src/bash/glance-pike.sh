...
echo example image registration with glance cli using a downloaded fedora-atomic.qcow2 image file:
echo glance image-create --name fedora-atomic --visibility public --disk-format qcow2 --property os_distro='fedora-atomic' --container-format bare --file fedora-atomic.qcow2 --progress
